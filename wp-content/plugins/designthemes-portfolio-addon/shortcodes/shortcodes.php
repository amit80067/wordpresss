				...
				if($attrs['type'] == 'type4') {
					...
					$output .= '<div class="post-nav-container '.esc_attr($attrs['type']).'">';
						...
						if( !empty( $prev_post ) ):
							...
							$output .= '<div class="post-prev-link no-post">';
									$output .= '<p>'.'<i class="fas fa-chevron-left"> </i>'.esc_html__('Prev Entry','dtportfolio').'</p>';
							$output .= '</div>';
						endif;
						...
						if( !empty( $next_post ) ):
							...
							$output .= '<div class="post-next-link no-post">';
									$output .= '<p>'.esc_html__('Next Entry','dtportfolio').'<i class="fas fa-chevron-right"> </i>'.'</p>';
							$output .= '</div>';
						endif;
					$output .= '</div>';
					...
					$output .= '<div class="post-nav-container '.esc_attr($attrs['type']).'">';
						if(isset($prev_post) && !empty($prev_post)) {
							...
							$output .= '<div class="post-prev-link no-post">';
								$output .= '<i class="fas fa-chevron-left"> </i>';
								$output .= '<p>'.esc_html__('Prev Entry','dtportfolio').'</p>';
								$output .= '<a href="#">'.esc_html__('No item to show!', 'augury').'</a>';
							$output .= '</div>';
						}
						...
						if(isset($next_post) && !empty($next_post)) {
							...
							$output .= '<div class="post-next-link no-post">';
									$output .= '<p>'.esc_html__('Next Entry','dtportfolio').'</p>';
									$output .= '<i class="fas fa-chevron-right"> </i>';
									$output .= '<a href="#">'.esc_html__('No item to show!', 'augury').'</a>';
							$output .= '</div>';
						}
					...
					$output .= '<div class="post-nav-container '.esc_attr($attrs['type']).'">';
						...
						if( !empty( $prev_post ) ):
							...
							$output .= '<div class="post-prev-link no-post">';
									$output .= '<p><i class="fas fa-chevron-left"> </i></p>';
							$output .= '</div>';
						endif;
						...
						if( !empty( $next_post ) ):
							...
							$output .= '<div class="post-next-link no-post">';
									$output .= '<p><i class="fas fa-chevron-right"> </i></p>';
							$output .= '</div>';
						endif;
					$output .= '</div>';
	...
	function dtportfolio_terms($attrs, $content = null) {
		...
		if($attrs['portfolio_id'] != '') {
			...
			$output .= '<div class="dtportfolio-terms-holder '.esc_attr($attrs['class']).'">';
				...
				if($attrs['with_icon']) {
					$output .= get_the_term_list($attrs['portfolio_id'], 'portfolio_entries', '<p class="dtportfolio-categories"><i class="fas fa-tags"></i>', ', ', '</p> ');
				} else {
