				...
				# Show Details Below Image
					$this->add_control( 'portfolio-details-below-image', array(
						...
						'options' => array(
							...
							'details-aside' 	  => esc_html__('Details Aside', 'dtportfolio'),
						),
					) );	
				...
				# Post Layout
					$this->add_control( 'portfolio-post-layout', array(
						...
						'condition' => [
							...
							'portfolio-details-below-image' => array('', 'details-below-image')
						],
						'description' => esc_html__("Recommended to use One column for 'Details Aside' type.", "dtportfolio")
					) );
