...
class DTPortfolioAddonPostType {
	...
	function __construct() {
		...
		add_filter ( 'dtm_metabox_options', array ( $this, 'dtportfolio_portfolio_cs_metabox_options' ) );
	...
	function dtportfolio_portfolio_cs_metabox_options( $options ) {
		...
		$custom_field_1 = augury_get_option( 'dt-portfolio-custom-field-1' );
		array_push($custom_fields, $custom_field_1);

		$custom_field_2 = augury_get_option( 'dt-portfolio-custom-field-2' );
		array_push($custom_fields, $custom_field_2);

		$custom_field_3 = augury_get_option( 'dt-portfolio-custom-field-3' );
		array_push($custom_fields, $custom_field_3);

		$custom_field_4 = augury_get_option( 'dt-portfolio-custom-field-4' );
		array_push($custom_fields, $custom_field_4);

		$custom_field_5 = augury_get_option( 'dt-portfolio-custom-field-5' );
		array_push($custom_fields, $custom_field_5);
		...
		if(!empty($custom_fields)) :
			...
			foreach($custom_fields as $field):
				...
				if($field != '') {
					...
					$fielddef['portfolio_opt_flds_title_'.$i] = $field;
