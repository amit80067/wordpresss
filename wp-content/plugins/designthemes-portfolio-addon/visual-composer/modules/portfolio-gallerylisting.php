	...
	vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				'description' => esc_html__( 'Comma separated gallery item ids to display particular gallery items only. You can find the "Gallery ID" in below "Gallery Options".', 'dtportfolio' ),
				'edit_field_class' => 'vc_column vc_col-sm-6',
				'admin_label' => true
			),			
