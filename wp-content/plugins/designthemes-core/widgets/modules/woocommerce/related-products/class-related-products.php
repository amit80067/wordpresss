...
class DTElementor_Woo_Related_Products extends DTElementorWidgetBase {
	...
	public function get_title() {
		return __( 'Product Single - Related Products', 'dt-elementor' );
	}

	public function get_style_depends() {
		return array( 'dtel-product-single-related-products' );
	}
	...
	protected function render() {
		...
		if($settings['product_id'] != '') {
			...
			$output .= '<div class="dt-sc-product-related-products '.$settings['class'].'">';
				...
				$output .= augury_product_style_setup_template_prop($product_style_template); /* Call Product Style Variables Setup */
