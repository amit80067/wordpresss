 ...
 *
 */
class DTMFramework_Option_typography extends DTMFramework_Options {
  ...
  public function output() {
    ...
    $google_json   = dtm_get_google_fonts();
    ...
    if( is_object( $google_json ) ) {
      ...
      echo '<optgroup label="'. esc_attr__( 'Web Safe Fonts', 'augury' ) .'">';
      ...
      echo '<optgroup label="'. esc_attr__( 'Google Fonts', 'augury' ) .'">';
      ...
      echo esc_html__( 'Error! Can not load json file.', 'augury' );
