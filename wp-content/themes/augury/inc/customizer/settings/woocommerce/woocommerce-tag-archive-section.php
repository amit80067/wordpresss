 ...
 */
	$wp_customize->add_setting(
		AUGURY_SETTINGS . '[dt-woo-tag-archive-layout]', array(
			'default'           => augury_get_option( 'dt-woo-tag-archive-layout' ),
			'type'              => 'option',
	...
	$wp_customize->add_control(
		new Augury_Customize_Control_Radio_Image(
			$wp_customize, AUGURY_SETTINGS . '[dt-woo-tag-archive-layout]', array(
				'type'     => 'dt-radio-image',
				'label'    => esc_html__( 'Layout', 'augury'),
				'section'  => 'woocommerce-tag-archive-section',
				'choices'  => apply_filters( 'augury_tag_archive_layout_options', array(
 ...
 */
	$wp_customize->add_setting(
		AUGURY_SETTINGS . '[dt-woo-tag-archive-show-standard-sidebar]', array(
			'default'           => augury_get_option( 'dt-woo-tag-archive-show-standard-sidebar' ),
			'type'              => 'option',
	...
	$wp_customize->add_control(
		new Augury_Customize_Control_Switch(
			$wp_customize, AUGURY_SETTINGS . '[dt-woo-tag-archive-show-standard-sidebar]', array(
				'type'    => 'dt-switch',
 ...
 */
	$wp_customize->add_setting(
		AUGURY_SETTINGS . '[dt-woo-tag-archive-widgetareas]', array(
			'default'           => augury_get_option( 'dt-woo-tag-archive-widgetareas' ),
			'type'              => 'option',
			'sanitize_callback' => array( 'Augury_Customizer_Sanitizes', 'sanitize_choices' ),
		)
	);
	...
	$wp_customize->add_control(
		AUGURY_SETTINGS . '[dt-woo-tag-archive-widgetareas]', array(
			...
			'section'  => 'woocommerce-tag-archive-section',
			'choices'  => apply_filters( 'augury_tag_archive_widgetareas', augury_customizer_custom_widgets() ),
			'dependency' => array( 'dt-woo-tag-archive-layout', 'any', 'with-left-sidebar,with-right-sidebar' )
		)
	);
 ...
 */
	$wp_customize->add_setting(
		AUGURY_SETTINGS . '[dt-woo-tag-archive-product-per-page]', array(
			'default'           => augury_get_option( 'dt-woo-tag-archive-product-per-page' ),
			'type'              => 'option',
 ...
 */
	$wp_customize->add_setting(
		AUGURY_SETTINGS . '[dt-woo-tag-archive-product-layout]', array(
			'default'           => augury_get_option( 'dt-woo-tag-archive-product-layout' ),
			'type'              => 'option',
			'sanitize_callback' => array( 'Augury_Customizer_Sanitizes', 'sanitize_choices' ),
		)
	);
	...
	$wp_customize->add_control(
		new Augury_Customize_Control_Radio_Image(
			$wp_customize, AUGURY_SETTINGS . '[dt-woo-tag-archive-product-layout]', array(
				'type'     => 'dt-radio-image',
				'label'    => esc_html__( 'Product Layout', 'augury'),
				'section'  => 'woocommerce-tag-archive-section',
				'choices'  => apply_filters( 'augury_tag_archive_product_layout_options', array(
 ...
 */
$wp_customize->add_setting(
	AUGURY_SETTINGS . '[dt-woo-tag-product-style-template]', array(
		'default'           => augury_get_option( 'dt-woo-tag-product-style-template' ),
		'type'              => 'option',
		'sanitize_callback' => array( 'Augury_Customizer_Sanitizes', 'sanitize_choices' ),
	)
);
...
$wp_customize->add_control(
	new Augury_Customize_Control(
		$wp_customize, AUGURY_SETTINGS . '[dt-woo-tag-product-style-template]', array(
			'type'     => 'select',
 ...
 */
	$wp_customize->add_setting(
		AUGURY_SETTINGS . '[dt-woo-tag-archive-enable-breadcrumb]', array(
			'default'           => augury_get_option( 'dt-woo-tag-archive-enable-breadcrumb' ),
			'type'              => 'option',
			'sanitize_callback' => array( 'Augury_Customizer_Sanitizes', 'sanitize_tweek' ),
		)
	);
	...
	$wp_customize->add_control(
		new Augury_Customize_Control_Switch(
			$wp_customize, AUGURY_SETTINGS . '[dt-woo-tag-archive-enable-breadcrumb]', array(
				'type'    => 'dt-switch',
