<?php
/**
 * Augury Theme Customizer Control: radio-image
 *
 */
...
class Augury_Customize_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'augury-radio-image-control', AUGURY_URI . '/inc/customizer/controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), AUGURY_VERSION, true );
		wp_enqueue_style( 'augury-radio-image-control',  AUGURY_URI . '/inc/customizer/controls/radio-image/radio-image.css', null, AUGURY_VERSION );
	}
