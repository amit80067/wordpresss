<?php
/**
 * Augury Theme Customizer Control: Upload
 *
 */
...
class Augury_Customize_Control_Upload extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'augury-upload-control',  AUGURY_URI . '/inc/customizer/controls/upload/upload.css', null, AUGURY_VERSION );
		wp_enqueue_script( 'augury-upload-control', AUGURY_URI . '/inc/customizer/controls/upload/upload.js', array( 'jquery', 'customize-base' ), AUGURY_VERSION, true );
	}
                ...
                <div class="upload-file">
                    <div class="attachment-file-view upload-file">
                        ...
                        <div class="actions">
                            ...
                            <button type="button" class="button upload-file-button"><?php esc_attr_e( 'Select File', 'augury' ); ?></button>
                        </div>
                    </div>
                </div>
			</div>
