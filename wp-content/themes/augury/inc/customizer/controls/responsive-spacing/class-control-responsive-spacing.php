<?php
/**
 * Augury Theme Customizer Control: Responsive Spacing Field
 *
 */
...
class Augury_Customize_Control_Responsive_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'augury-responsive-spacing-control', AUGURY_URI . '/inc/customizer/controls/responsive-spacing/responsive-spacing.js', array( 'jquery', 'customize-base' ), AUGURY_VERSION, true );
		wp_enqueue_style( 'augury-responsive-spacing-control',  AUGURY_URI . '/inc/customizer/controls/responsive-spacing/responsive-spacing.css', null, AUGURY_VERSION );
	}
