<?php
/**
 * Augury Theme Customizer Control: Switch Field
 *
 */
...
class Augury_Customize_Control_Switch extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'augury-switch-control',  AUGURY_URI . '/inc/customizer/controls/switch/switch.css', null, AUGURY_VERSION );
		wp_enqueue_script( 'augury-switch-control', AUGURY_URI . '/inc/customizer/controls/switch/switch.js', array( 'jquery', 'customize-base' ), AUGURY_VERSION, true );		
	}
			...
			<div class="customize-control-content switch">
				...
				<label class="switch-label" for="switch_{{ data.id }}">
					<span class="switch-on">
						<# data.choices.on = data.choices.on || '<?php esc_html_e( 'On', 'augury' ); ?>' #>
						{{ data.choices.on }}
					</span>
					<span class="switch-off">
						<# data.choices.off = data.choices.off || '<?php esc_html_e( 'Off', 'augury' ); ?>' #>
						{{ data.choices.off }}
					</span>
				</label>
			</div>
