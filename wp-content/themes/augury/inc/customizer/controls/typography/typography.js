wp.customize.controlConstructor['dt-typography'] = wp.customize.Control.extend({
	...
	resetValue: function() {
		...
		this.container.find("div.font-size .item-reset").click(function(){
		...
		this.container.find("div.line-height .item-reset").click(function(){
		...
		this.container.find("div.letter-spacing .item-reset").click(function(){
