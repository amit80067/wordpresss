<?php
/**
 * Augury Theme Customizer Control: Responsive slider
 *
 */
...
class Augury_Customize_Control_Responsive_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'augury-responsive-slider-control', AUGURY_URI . '/inc/customizer/controls/responsive-slider/responsive-slider.js', array( 'jquery', 'customize-base' ), AUGURY_VERSION, true );
		wp_enqueue_style( 'augury-responsive-slider-control',  AUGURY_URI . '/inc/customizer/controls/responsive-slider/responsive-slider.css', null, AUGURY_VERSION );
	}
