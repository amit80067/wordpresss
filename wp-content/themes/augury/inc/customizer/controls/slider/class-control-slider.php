<?php
/**
 * Augury Theme Customizer Control: slider
 *
 */
...
class Augury_Customize_Control_Slider extends WP_Customize_Control {
	...
	*/
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'augury-slider-control', AUGURY_URI . '/inc/customizer/controls/slider/slider.js', array( 'jquery', 'customize-base' ), AUGURY_VERSION, true );
		wp_enqueue_style( 'augury-slider-control',  AUGURY_URI . '/inc/customizer/controls/slider/slider.css', null, AUGURY_VERSION );
	}
