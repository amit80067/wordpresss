<?php
/**
 * Augury Theme Customizer Control: sortable
 *
 */
...
class Augury_Customize_Control_Sortable extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'augury-sortable-control', AUGURY_URI . '/inc/customizer/controls/sortable/sortable.js', array( 'jquery', 'customize-base' ), AUGURY_VERSION, true );
		wp_enqueue_style( 'augury-sortable-control',  AUGURY_URI . '/inc/customizer/controls/sortable/sortable.css', null, AUGURY_VERSION );
	}
