<?php
/**
 * Augury Theme Customizer Control: Responsive Number Field
 *
 */
...
class Augury_Customize_Control_Responsive_Number extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'augury-responsive-number-control', AUGURY_URI . '/inc/customizer/controls/responsive-number/responsive-number.js', array( 'jquery', 'customize-base' ), AUGURY_VERSION, true );
		wp_enqueue_style( 'augury-responsive-number-control',  AUGURY_URI . '/inc/customizer/controls/responsive-number/responsive-number.css', null, AUGURY_VERSION );
	}
